...
c.InteractiveShellApp.exec_lines = ['import numpy as np', 'import matplotlib.pyplot as plt', 'import pandas as pd', 'import scipy', 'import tifffile', 'import gdal']
...
c.TerminalInteractiveShell.editor = '/Applications/Sublime.app/Contents/SharedSupport/bin/subl'

# Deprecated, use PromptManager.justify
# c.TerminalInteractiveShell.prompts_pad_left = True

# The part of the banner to be printed before the profile
# c.TerminalInteractiveShell.banner1 = 'Python 2.7.9 (v2.7.9:648dcafa7e5f, Dec 10 2014, 10:10:46) \nType "copyright", "credits" or "license" for more information.\n\nIPython 3.2.1 -- An enhanced Interactive Python.\n?         -> Introduction and overview of IPython\'s features.\n%quickref -> Quick reference.\nhelp      -> Python\'s own help system.\nobject?   -> Details about \'object\', use \'object??\' for extra details.\n'
